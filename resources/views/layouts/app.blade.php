                    ...
                    <div class="flex items-center ms-3">
                        <div class="flex items-center gap-7 space-x-2">
                            ...
                            <div class="relative flex items-center group">
                                <!-- Tooltip Text -->
                                <span
                                    class="absolute left-[-110%] bottom-1/2 transform -translate-x-1/2 translate-y-1/2 px-2 py-1 text-xs text-white bg-green-700 rounded whitespace-nowrap overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    Riwayat Transaksi
                                </span>
                ...
                @php
                    $menus = [
                        ...
                        'Pelanggan' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"class="w-5 h-5">
                                    ...
                                    ',
                        'Point' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"class="w-5 h-5">
                        ...
                        'Unit' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"class="w-5 h-5">
                                    ...
                                    ',
                        'UnitPaket' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"class="w-5 h-5">
